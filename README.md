...
**Как происходит отправка:** нажатие «Согласовать и отправить» — это подтверждение менеджера. Заказ отмечается согласованным, Excel скачивается, и открывается WhatsApp или Telegram с готовым текстом: поставщик, количество позиций и штук, сумма по известным ценам и первые 15 позиций. Получателя выбирает менеджер, файл Excel прикрепляется к сообщению. На телефоне «Поделиться файлом» отправляет Excel сразу.
