...
### Дефицит забирает прибыль. Излишки забирают деньги из оборота.

**Система заранее показывает, какой товар закончится, сколько прибыли находится под риском и что нужно заказать сегодня, чтобы сохранить продажи через 45 дней.**
...
|---|---:|---|
| Позиций, которые рекомендуется заказать | **1 227** | такой объём невозможно качественно пересчитывать вручную каждый день |
| Заказать сегодня | **697** | последний безопасный день заказа уже наступил или прошёл |
| Ожидаемый дефицит | **691** | товар закончится раньше, чем придёт заказ, размещённый сегодня |
| Критических позиций | **479** | существующего запаса может не хватить до прихода следующей поставки |
| Позиций к заказу с нулевым остатком | **413** | часть спроса уже может превращаться в упущенные продажи |
...
|---|---:|---:|
| Ошибка прогноза (WAPE) | **22,8%** | 29,1% |
| Смещение (bias) | **+0,1%** | +16,2% (систематически завышает) |
...
| Эффект | Результат |
|---|---:|
| Потенциально лишнее количество без очистки данных | **60 327 единиц** |
| Стоимость потенциально лишнего пополнения по известным ценам | **около 9,13 млн ₸** |
...
Фильтрация единичных крупных продаж уменьшила модельную закупку на **60 327 единиц**. По товарам, где цена известна, это примерно **9,13 млн ₸ модельно меньшей закупки** (по себестоимости, без учёта маржи).
...
> **Честный вывод:** система уже нашла, где компания может не потратить лишние 9,13 млн ₸ и где около 30,2 млн ₸ капитала требует проверки и возможного высвобождения. Но это пока найденный финансовый резерв, а не деньги на банковском счёте.
